...
* Japanese (`ja`): `NotoSansCJKjp-Regular.otf` (preferred) or `NotoSansJP-Regular.otf`
* Simplified Chinese (`zh-CN`): `NotoSansCJKsc-Regular.otf` (preferred) or `NotoSansSC-Regular.otf`
