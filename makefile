...
OBJS = sdl2-blocks.cpp Video.cpp Input.cpp Sprite.cpp Block.cpp GameModel.cpp \
		...
		HighScores.cpp Audio.cpp ./src/State/MenuState.cpp ./src/State/OptionMenuState.cpp \
		./src/State/PlayState.cpp ./src/State/PauseState.cpp ./src/State/IntroState.cpp \
		./src/State/GameStateMachine.cpp ./src/State/GameOverState.cpp
