...
OBJS = $(OBJDIR)/sdl2-blocks.o $(OBJDIR)/src/gfx/Video.o $(OBJDIR)/src/Input.o $(OBJDIR)/src/Sprite.o $(OBJDIR)/src/Block.o $(OBJDIR)/src/GameModel.o $(OBJDIR)/src/GameModel_setup.o \
       ...
       $(OBJDIR)/src/UI/TextEntry.o $(OBJDIR)/src/Fader.o $(OBJDIR)/src/Board.o $(OBJDIR)/src/LanguageModel.o \
       $(OBJDIR)/src/State/BlockEditorState.o $(OBJDIR)/src/UI/UI_Tile.o $(OBJDIR)/src/Layout.o $(OBJDIR)/src/UI/UIWidget.o \
       $(OBJDIR)/src/ConfigIO.o $(OBJDIR)/src/State/BaseState.o $(OBJDIR)/src/Command.o $(OBJDIR)/src/Theme.o \
       $(OBJDIR)/src/gfx/Particle.o
